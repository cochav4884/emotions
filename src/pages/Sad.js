    ...
    <div className="container my-5 text-center">
      ...
      <article className="text-start mx-auto" style={{ maxWidth: "900px" }}>
        ...
        <ul className="emotion mt-4">
          ...
          <li>Stick with "I" statements (I am feeling..., I am sad because..., I want to try...).</li>
          <li>Write down what is making you sad (when you are finished, crumple it up and throw it away).</li>
          <li>

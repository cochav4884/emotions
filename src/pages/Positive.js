...
const Positive = () => {
  return (
    <div className="container my-5 text-center">
      ...
      <div>
        <img src={positive1} alt="Anger 1" width="600" height="550" />
        <img src={positive2} alt="Anger 2" width="600" height="550" />
        <img src={positive3} alt="Anger 3" width="600" height="550" />
      </div>
      ...
      <article className="text-start mx-auto" style={{ maxWidth: "900px" }}>
        ...
        <ul className="emotion mt-4">
          <li>
            Understand why you are feeling positive and share that knowledge
            with someone else.
          </li>
          ...
          <li>
            Choose a physical activity to do with others such as running,
            swimming, exercising, or playing a sport.
          </li>
          <li>
            Help others who are having a bad day (keep in mind your feeling of
            positivity — don’t let their bad day become your bad day).
          </li>
          <li>
            Stick with "I" statements when working with others (I am feeling...,
            I am awesome because..., I want to try...).
          </li>
          ...
          <li>
            ...
            saying, and take your time to think about it before you respond.
          </li>
